...
public class InterviewScoreService {
    ...
    public InterviewScoreService(InterviewAnswerRepository answers, ObjectMapper om) {
        this.answers = answers;
        this.om = om;
    }

    public ScoresDto computeScores(UUID sessionId) {
        List<InterviewAnswer> list = answers.findBySession_IdOrderByQuestionIndexAsc(sessionId);
