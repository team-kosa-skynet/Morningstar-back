...
public class OpenaiQuestionService {
    ...
    public OpenaiQuestionResponseDto createQuestion(
        ...
        // OpenAI Responses API 요청 데이터 준비
        ...
        try {
            ...
            String content = extractResponsesContent(responseBody);
    ...
    private String extractResponsesContent(Map<String, Object> responseBody) {
        try {
            // OpenAI Responses API 응답 구조: output 배열 내 content 배열
